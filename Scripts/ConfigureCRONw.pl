...
# --
# $Id: ConfigureCRONw.pl,v 1.1.1.1 2008-11-11 02:21:17 mh Exp $
# --
...
my $CRONwDirQuoated = $CRONwDir;
$CRONwDirQuoated =~ s{\\}{/}xmsg;
...
\"$InstallDir\\StrawberryPerl\\perl\\bin\\perl.exe\" \"$InstallDir\\OTRS\\bin\\Cron4Win32.pl\"
NET START CRON";
